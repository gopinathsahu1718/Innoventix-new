...
function TeamCard({ member, index, isVisible }: TeamCardProps) {
  ...
  return (
    <div
      className={`relative h-[400px] perspective-1000 transition-all duration-700 ${
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 backface-hidden">
          <div className="h-full bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            {/* Avatar */}
            <div 
              className="h-48 flex items-center justify-center"
              style={{ background: `linear-gradient(135deg, ${member.color}20 0%, ${member.color}40 100%)` }}
            >
              <div 
                className="w-28 h-28 rounded-full flex items-center justify-center text-white text-3xl font-bold font-accent shadow-lg"
            ...
            <div className="p-6 text-center">
              ...
              <div className="flex justify-center gap-3 mt-6">
                <button 
                  className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-[#0e43a6] hover:text-white transition-all duration-300"
        ...
        >
          <div 
            ...
            style={{ background: `linear-gradient(135deg, ${member.color} 0%, ${member.color}dd 100%)` }}
          >
